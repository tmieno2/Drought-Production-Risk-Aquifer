...
{\centering \includegraphics[height=4in]{Figures/g_share} 
...
{\centering \includegraphics[height=5in]{Figures/g_total_impact} 
...
{\centering \includegraphics{../../Shared/Results/g_avg_yield_dif} 
...
\hypertarget{more-on-the-impact-of-water-deficit-on-irrigated-and-average-yield}{%
\section{More on the impact of water deficit on irrigated and average yield}\label{more-on-the-impact-of-water-deficit-on-irrigated-and-average-yield}}
...
{\centering \includegraphics[width=6in]{../../Shared/Results/g_yield_with_conf_corn} 

}

\caption{The impact of water deficit and aquifer thickness on rainfed and irrigated per-area yields of corn in US High Plains with 95 percent confidence interval}\label{fig:irrigated-yield-ind-corn}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=6in]{../../Shared/Results/g_yield_with_conf_soy} 

}

\caption{The impact of water deficit and aquifer thickness on rainfed and irrigated per-area yields of soybean in US High Plains with 95 percent confidence interval}\label{fig:irrigated-yield-ind-soy}
\end{figure}

\begin{figure}

{\centering \includegraphics[width=6.5in]{../../Shared/Results/g_avg_yield} 
...
\hypertarget{county-fixed-effects-in-irrigation-share-regression}{%
\section{County Fixed Effects in Irrigation Share Regression}\label{county-fixed-effects-in-irrigation-share-regression}}
...
{\centering \includegraphics[height=6in]{Figures/g_variation} 
...
{\centering \includegraphics[height=6in]{Figures/g_share_comp} 
...
\hypertarget{spline-basis-functions-and-gam-estimation}{%
\section{Spline basis functions and GAM estimation}\label{spline-basis-functions-and-gam-estimation}}
...
{\centering \includegraphics[width=6in,height=4in]{manuscript_files/figure-latex/sp-basis-1} 
...
{\centering \includegraphics[width=6in,height=4in]{manuscript_files/figure-latex/ex-fx-1} 
