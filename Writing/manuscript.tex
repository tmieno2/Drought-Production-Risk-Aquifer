...
{\centering \includegraphics[width=6in,height=500px,]{../../Shared/Results/g_avg_yield_dif} 
...
{\centering \includegraphics[width=6in,height=500px,]{../../Shared/Results/g_yield_with_conf_corn} 
...
{\centering \includegraphics[width=6in,height=500px,]{../../Shared/Results/g_yield_with_conf_soy} 
...
{\centering \includegraphics[width=6.5in,height=500px,]{../../Shared/Results/g_avg_yield} 
