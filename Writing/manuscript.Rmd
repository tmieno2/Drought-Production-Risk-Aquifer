...
knitr::include_graphics(here::here("Shared/Results/g_avg_yield_dif.pdf"))
```
...
```{=Tex}
\begin{equation}
    log(\frac{s_{i,t}}{1-s_{i,t}}) = \beta_0 + \sum_{k}^K \alpha_{k}\phi_{k}(WB_{i}) + \sum_{l}^L \beta_{l}\tau_{l}(AT_{i,t}) + \theta_s + \mu_t + v_{i,t} (\#eq:eqn2)
\end{equation}
```
