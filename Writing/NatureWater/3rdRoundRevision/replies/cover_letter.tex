...
\begin{itemize}
    \item Fix a coding error that was creating invalid observations for our regressions analysis of the share of irrigated acres. Consequently, our results changed slightly. But, our main conclusions and qualitative results are robust and did not change. 
    \item We added histograms of aquifer thickness in Figure 3 as suggested by reviewer 3.
    \item We added another section in Appendix (Appendix A) that discusses groundwater regulations in response to declines in aquifer thickness as a causal pathway through which aquifer thickness affects yield. This is in response to a comment from reviewer 3.
\end{itemize}
