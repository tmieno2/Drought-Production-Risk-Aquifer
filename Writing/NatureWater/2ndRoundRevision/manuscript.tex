...
Some parts of the HPA region face regulatory pumping restrictions in response to declines in aquifer thickness. Resulting groundwater use reductions can in turn negatively affect crop yield. This causal pathway of aquifer thickness affecting crop yield is distinct from the pathways via well yield discussed in the \ref{main} section. However, it is unlikely that our regression analysis capture this effect. 
