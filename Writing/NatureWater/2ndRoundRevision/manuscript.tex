...
\caption{The estimated impact of aquifer thickness on the share of agricultural production under irrigation for corn and soybean producing counties in the US High Plains (Note: shaded area represents 95\% confidence interval)}\label{fig:ir-share}
\end{figure}
...
\caption{Difference in average yield of corn and soybean for aquifer thickness levels of 50 m, 90 m, and 130 m, relative to a baseline aquifer thickness of 10 m. Shaded areas denote 95\% confidence interval, which when greater than zero indicate average yields for the given aquifer thickness level are statistically significantly greater than for an aquifer thickness of 10 m at the 5\% level of significance.}\label{fig:dif-tot-impact}
\end{figure}
...
\begin{equation}
    log(\frac{s_{i,t}}{1-s_{i,t}}) = \beta_0 + \sum_{k=1}^K \alpha_{k}\phi_{k}(WB_{i}) + \sum_{l=1}^L \beta_{l}\tau_{l}(AT_{i,t}) + X_i + \theta_{s,t} + \mu_t + v_{i,t} \label{eq:eqn2}
\end{equation}
...
\caption{Decline in the share of acres that are irrigated as a function of different levels of aquifer thickness relative to a baseline aquifer thickness level of 130 m (black line). The grey shaded areas represent the 95\% confidence interval for this estimated relationship.}\label{fig:test-sat-share}
\end{figure}
