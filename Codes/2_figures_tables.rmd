...
# Figure 1: Yield response to water deficit by saturated thickness level (intensive margin) 
...
# Figure 2: Test the significance of the difference in irrigated yield between the aquifer thickness categories
...
# Figure 3: The impact of saturated thickness on the share of irrigated production
...
# Figure 4: Total impact of a decline in saturated thickness on average yield
...
# Figure 5: Testing of the significance of yield difference (average total impact)
...
# Water deficit by year (Figure 6)
...
# Saturated Thickness Map (Figure 7)
...
## Figure S.3: The impact of water deficit on average yield by aquifer thickness category with confidence interval
...
# Figure S.4: Difference in the share of irrigated production (from 100)
