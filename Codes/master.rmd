...
```{r}
knitr::purl(here("Codes/A_1_state_fe.Rmd"), here("Codes/A_1_state_fe.R"))
source(here("Codes/A_1_state_fe.R"))
```

```{r}
knitr::purl(here("Codes/A_2_spline.Rmd"), here("Codes/A_2_spline.R"))
source(here("Codes/A_2_spline.R"))
```
