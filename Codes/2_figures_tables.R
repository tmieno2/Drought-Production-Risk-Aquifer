...
saveRDS(hpa_simplified, here("Data/data-processed/hpa_simplified.rds"))


## ---------------------------------------------------------------------
#--- hpa ---#
hpa_simplified <-
  here("Data/data-processed/hpa_simplified.rds") %>%
  readRDS()
...
all_counties <- readRDS("Data/data-processed/counties.rds")

#--- all relevant states ---#
all_states <- readRDS("Data/data-processed/states.rds")
...
ggsave("Results/Figures/g_yield_with_conf_corn.pdf", g_yield_with_conf[crop == "corn", g_fig][[1]], width = 5, height = 3.5)
ggsave("Results/Figures/g_yield_with_conf_soy.pdf", g_yield_with_conf[crop == "soy", g_fig][[1]], width = 5, height = 3.5)
...
ggsave("Results/Figures/g_avg_yield.pdf", g_ay_response, width = 5, height = 4)
