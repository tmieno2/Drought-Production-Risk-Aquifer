...
#   data.table()
# saveRDS(all_counties, "Shared/Data/counties.rds")
...
# saveRDS(all_states, "Shared/Data/states.rds")
...
# g_yield_response <-
#   cowplot::plot_grid(
#     g_wd_corn, g_ir_yield_corn,
#     ncol = 1,
#     align = "v",
#     rel_heights = c(0.15, 0.72)
#   )

# g_yield_response_soy <-
#   cowplot::plot_grid(
#     g_wd_soy, g_ir_yield_soy,
#     ncol = 1,
#     align = "v",
#     rel_heights = c(0.15, 0.72)
#   )
