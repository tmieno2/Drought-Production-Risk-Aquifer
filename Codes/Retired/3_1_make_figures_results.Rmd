...
```{r yield-intensive-balance, fig.cap = "The Impact of Saturated Thickness on Irrigated Yield", fig.height = 4, fig.width = 6.5}
(
g_intensive_balance <- 
  sim_results %>% 
...
```{r yield-intensive-d35, fig.cap = "The Impact of the Number of Days above 35 on Irrigated Yield at Various Saturated Thickness Levels", fig.height = 4, fig.width = 6.5}
(
g_intensive_d35 <- 
  sim_results %>% 
  filter(model_name == "balance_d35") %>% 
