...
```{r hist-sat-trend, fig.cap = "Saturated thickness trend (1990-2016)"}
ggplot() +
  geom_histogram(
    data = sat_sf, 
    aes(x = beta_sat), 
...
```{r hist-sat-level, fig.cap = "Mean saturated thickness (1990-2016)"}
ggplot() +
  geom_histogram(
    data = sat_sf, 
    aes(x = sat_mean), 
...
```{r hist-sat-level-b100, fig.cap = "Mean saturated thickness (less than 100) (1990-2018)"}
ggplot() +
  geom_histogram(
...
```
```{r hist-sat-map, fig.cap = "Map of mean saturated thickness (1990-2018)"}
ggplot() +
...
```{r cl-trend-future, fig.cap = "Water deficit, ET0, and precipitation by period (model mixed)"}
